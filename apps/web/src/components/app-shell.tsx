...
const allNavItems = [
  ...
  { href: '/employees', icon: Briefcase, label: 'Employees', roles: ['Admin', 'Employee'], excludeJobTitles: ['Field Agent'] },
  ...
  { href: '/ai-insights', icon: WandSparkles, label: 'AI Insight', roles: ['Admin', 'Employee'], excludeJobTitles: ['Field Agent'] },
];
