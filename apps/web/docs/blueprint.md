...
- Offline Sync Logic: Detects internet connectivity and automatically synchronizes local records with Supabase, resolving any data conflicts to maintain consistency with Supabase as the source of truth.
...
- Authentication and Roles: Utilizes Supabase Authentication for user login, implementing role-based access control to restrict access based on user roles (Admin, Employee).
